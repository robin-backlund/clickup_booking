...
// Visa bara tider som är tillgängliga tex dra en query som bara visar de som inte finns i upptaget table.
// Tror att det blir lättare om man bara ser tider som är tillgängliga.
// Blir dessutom lättare och renare att koda.

// Istället för att ha ett extra table så kanske man bör köra på att ha en extra kolumn med ett binärt värde. 1 = upptaget 0 = ledigt.
// Typ unless ID = 1 SELECT * FROM tider;
